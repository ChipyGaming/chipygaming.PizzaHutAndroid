...
//    private GoogleApiClient googleApiClient;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng currlocation = new LatLng(33.412815, -111.9091);
        LatLng destination = new LatLng(33.3257117, -111.93901);
        LatLng zaragoza = new LatLng(41.648823,-0.889085);
        //mMap.addMarker(new MarkerOptions().position(currlocation));
        //mMap.addMarker(new MarkerOptions().position(currlocation).title("Destination in " + estimatedDriveTime));
        GeoApiContext context = new GeoApiContext.Builder()
                .apiKey("AIzaSyB9S1oIkdcj1akJPZ1zUNx4dYHASxIeURE")
                .build();
        DirectionsApiRequest req = DirectionsApi.getDirections(context, "33.412815, -111.9091", "33.3257117,-111.93901");
        try {
    ...
    public void onLocationChanged(Location location) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("users/chipy");
